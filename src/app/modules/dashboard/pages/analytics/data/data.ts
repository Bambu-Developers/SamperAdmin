...
export const PRODUCTS_COLORS = [{ backgroundColor: '#ff9581', borderColor: 'transparent' }];


export const CLIENTS_ROUTE_COLORS = [{ backgroundColor: '#ffc567', borderColor: 'transparent' }];
